...
function all_posts(current_page) {
  ...
  .then(posts => { 
        ...
        let page_posts = profile_posts.slice(start, end)
        ...
        if (current_page > profile_posts_count/10) {
        ...
        for (i=0; i < profile_posts_count/10; i++) {
